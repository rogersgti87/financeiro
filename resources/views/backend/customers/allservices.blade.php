                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover mb-0">
                                    <thead>
                                        ...
                                        <th><a
                                                href="{{ request()->fullUrlWithQuery(['column' => 'nameCustomer', 'order' => $order]) }}"><i
                                        ...
                                        <form class="form" id="form-table">
                                            ...
                                            @foreach ($results as $result)
                                                <tr>
                                                    ...
                                                    <td>{{ $result->id }}</td>
                                                    <td><a
                                                            href="{{ route('backend.customers.show', $result->id) }}">{{ $result->nameCustomer }}</a>
                                                        @if ($result->company)
                                                            <small>({{ $result->company }})</small>@endif
                                                    </td>
                                                    <td>{{ $result->dominio }} - <small><b>{{ $result->nameService }}</b></small></td>
                                                    <td>{{ \Carbon\Carbon::parse($result->date_end)->format('d/m/Y') }}
