                        ...
                        <div class="card-body">
                            <h5 class="card-title">@yield('title') ({{ count($results) }}) <a href="#"
                                    class="btn btn-sm btn-success float-right" id="button-create" data-type="create"><i
                                        class="fa fa-plus"></i> Adicionar Backup</a></h5>
                            <hr>
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover mb-0">
                                    <thead>
                                        ...
                                        <th><a href=""><i class="fa fa-sort"></i></a> database</th>
                                        <th>Status</th>
                                        <th>Ações</th>
                                    </thead>
                                    <tbody>
                                                    ...
                                                    <td>
                                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                            <a href="#" id="button-edit" data-id="{{ $result->id }}"
                                                                ...
                                                                title="Editar Backup"><i class="fa fa-edit"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforeach
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <a href="#" class="btn btn-sm btn-success" id="button-create" data-type="create"><i
                                            class="fa fa-plus"></i> Adicionar Backup</a>
                                </div>
                            </div>
                                    ...
                                    <div class="modal-content">
                                        <form action="" class="form-horizontal" id="form-request">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="modalServicesLabel">Novo Backup</h5>
