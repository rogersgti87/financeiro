                        ...
                        <div class="card-body">
                            <h5 class="card-title">@yield('title') ({{ count($results) }}) <a href="#"
                                    class="btn btn-sm btn-success float-right" id="button-create" data-type="create"><i
                                        class="fa fa-plus"></i> Adicionar Serviço</a></h5>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover mb-0">
                                    <thead>
                                        ...
                                        <th><a href=""><i class="fa fa-sort"></i></a> Nome</th>
                                        <th><a href=""><i class="fa fa-sort"></i></a> Preço</th>
                            ...
                            <div class="modal fade" id="modalServices" tabindex="-1" role="dialog"
                                aria-labelledby="modalServicesLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <form action="" class="form-horizontal" id="form-request">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="modalServicesLabel">Novo Cliente</h5>
...
@section('jsPage')
    ...
    <script>
        function showPrices() {
            var selectedPeriod = $('select#period').val();
            if (selectedPeriod == 'unico') {
                $('.price_trimestral, .price_anual').hide();
            } else {
                $('.price_trimestral, .price_anual').show();
            }
        }
    </script>
