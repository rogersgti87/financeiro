...
class GenerateInvoiceCron extends Command
{
  ...
  public function handle()
  {
    ...
    AND CURRENT_DATE = DATE_ADD(DATE_ADD(CONCAT(YEAR(CURRENT_DATE),'-',MONTH(CURRENT_DATE),'-','01'), INTERVAL 1 MONTH), INTERVAL -5 DAY) AND a.status = 'ATIVO'";
